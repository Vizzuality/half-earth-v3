...
1. **Summary Statistics**: Sum together all the values that match `MOL_ID` and `SliceNumber`. This step is only needed in the geometries have been subdivided previously.
