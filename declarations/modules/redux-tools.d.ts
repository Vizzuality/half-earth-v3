...
declare module 'redux-tools' {
  ...
  export type BaseActionFunctions<TAction> =
    ...
    | ActionFunction1<unknown, TAction>
    | ActionFunction2<unknown, unknown, TAction>
    | ActionFunction3<unknown, unknown, unknown, TAction>
    | ActionFunction4<unknown, unknown, unknown, unknown, TAction>
  ...
  export function createAction(
    actionType: string
  ): ActionFunctionAny<Action<unknown>>;
  ...
  export function combineActions(
    ...actionTypes: Array<ActionFunctions<unknown> | string | symbol>
  ): CombinedActionType;
  ...
  export function createActions<Payload>(
    actionMapOrIdentityAction: ActionMap<Payload, unknown> | string,
  ...
  export function createActions(
    actionMapOrIdentityAction: ActionMap<unknown, unknown> | string,
    ...identityActions: Array<string | Options>
  ): {
    [actionName: string]: ActionFunctionAny<Action<unknown>>;
  };
}
