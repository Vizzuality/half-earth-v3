...
const LandscapeSidebarComponent = ({ 
  ...
  return (
    <div className={cx(uiStyles.uiTopLeft, styles.sidebar, animationStyles.transform, { [animationStyles.visible]: isLandscapeSidebarVisible, [animationStyles.hidden]: !isLandscapeSidebarVisible })}>
