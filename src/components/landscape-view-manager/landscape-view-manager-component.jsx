...
import { useSetLandscapeViewParam, useLandscapeViewCameraChange, useLandscapeViewClickOnProtectedArea } from 'hooks/landscape-view-hooks';
...
const LandscapeViewManager = ({ view, map, zoomLevelTrigger, onZoomChange, isLandscapeMode, activeLayers }) => {
  // tooltips handling
