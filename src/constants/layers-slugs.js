...
export const GADM_1_ADMIN_AREAS_WITH_WDPAS_FEATURE_LAYER = 'gadm-1-admin-areas-feature-layer';
export const GADM_1_ADMIN_AREAS_FEATURE_LAYER = 'gadm-1-admin-areas-with-wdpas-feature-layer';
