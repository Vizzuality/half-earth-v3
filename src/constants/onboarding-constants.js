export const SCRIPTS = {
  'priority-places': {
    ...
    priority: [
      { startTime: 0, endTime: 12.8, text: 'The priority layer identifies the minimum amount of land needed to provide a sufficient amount of habitat for all species represented on the' },
      { startTime: 12.8, endTime: 14, text: 'map. In this ranking of priority places, yellow areas correspond to those with higher priority for conservation, as they contribute to safeguarding' },
    ...
    // // CHANGE >> Times below are not correct
    protection: [
      ...
      { startTime: 50.8, endTime: 60, text: 'and accelerating species extinction. Click on the Human Pressures tab to explore how human activities overlap with natural ecosystems.' },
    ],
    'human-pressures': [
    ...
    spi: [
      { startTime: 0, endTime: 12.8, text: 'The Amazon region spreads across 9 countries. Brazil, for example, is home to a huge portion of biodiversity-rich rainforest, while other nations have' },
      { startTime: 12.8, endTime: 20, text: 'less. The network of priority protected areas in these regions is therefore a complicated patchwork that necessarily involves diverse' },
      { startTime: 25.2, endTime: 37.3, text: 'governments, agencies, and communities. The Half-Earth Project has developed a powerful indicator that measures how effective a nation' },
      { startTime: 37.3, endTime: 42.2, text: 'is in conserving biodiversity in their territory. We call this indicator the Species Protection Index, or SPI. The SPI takes into account the land and' },
      { startTime: 42.2, endTime: 50.8, text: 'water protected, the needs of rare endemic species, as well as the richness, or total species number, in both protected and unprotected habitats.' },
      { startTime: 50.8, endTime: 60, text: ' The SPI can be used to measure and compare how well each country is doing in meeting its conservation targets today and for goals going forward. To learn more about the SPI and the' },
      { startTime: 60, endTime: 70, text: 'specific challenges faced by each country, you can visit the “National Report Card” section, which you can find on the menu, or listen to the tour on this topic.' },
    ],
    closure: [
  ...
  'national-report-cards': {
    intro: [
      ...
      { startTime: 12.8, endTime: 25.2, text: `Report cards make it possible to see the varied conservation opportunities and challenges faced by each country in the world. Let's see what a report card looks like.` }
    ],
    spi: [
