...
export const SCRIPTS = {
  ...
  'national-report-cards': {
    intro: [
      ...
      { startTime: 22.15, endTime: 27.6, text: `as the basis for a National Report Card on every country in the world.` },
      { startTime: 27.6, endTime: 36.8, text: `Report cards make it possible to see the varied conservation opportunities and challenges faced by each country in the world.` },
