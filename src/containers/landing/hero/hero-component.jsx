  ...
  return (
    <div className={cx(styles.container, className)}>
      ...
      <div className={styles.audioCards}>
        <AudioCard number='01' gif={AUDIO_CARD_1_GIF} title='Priority places' description='Understand where the suggested priority places should happen for vertebrates.' />
        <AudioCard number='02' gif={AUDIO_CARD_2_GIF} title='National Report cards' description='Analyze national and other areas of interest. Download reports to share with others.' />
      </div>
    </div>
  )
}
