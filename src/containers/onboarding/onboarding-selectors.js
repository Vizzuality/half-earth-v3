...
const getOnboardingTooltipTop = createSelector(
  selectUiUrlState,
  (uiState) => uiState && uiState.onboardingTooltipTop
);
const getOnboardingTooltipLeft = createSelector(
  selectUiUrlState,
  (uiState) => uiState && uiState.onboardingTooltipLeft
);
export const getOnWaitingInteraction = createSelector(
  selectUiUrlState,
  (uiState) => uiState && uiState.waitingInteraction
);
