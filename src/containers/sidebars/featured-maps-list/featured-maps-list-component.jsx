...
const FeaturedMapsListComponent = ({
  ...
  const visibleOnMobile =
    isOnMobile && isActive && isOpen && !selectedFeaturedPlace;

  const isMapsListVisible =
    (isOpen && !isFullscreenActive && !isOnMobile) || visibleOnMobile;
  ...
  return (
    <div
      className={cx(styles.cardsContainer, {
        [animationStyles.leftHidden]: !isMapsListVisible && !isOnMobile,
        [animationStyles.bottomHidden]: !isMapsListVisible && isOnMobile,
        [styles.delayOnIn]: isMapsListVisible,
      })}
    >
      {featuredMapsList && (
        <button
      ...
      <div className={styles.scrollable}>
        {featuredMapsList &&
          featuredMapsList.map((featuredMap) => (
            <div
              key={featuredMap.slug}
              className={cx(styles.card, {
                [styles.border]: isCardSelected(featuredMap),
                [styles.hidden]: isHiddenOnMobile(featuredMap),
              })}
            ...
            >
              ...
              {selectedFeaturedMap &&
                cardOpen &&
                cardOpen.slug === featuredMap.slug && (
                    ...
                    {isOnMobile && (
                      <div className={styles.selectMapButtonContainer}>
                        <button
                          ...
                          onClick={() => selectCard(featuredMap)}
                        >
