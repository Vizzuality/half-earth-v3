...
export const getOnboardingType = createSelector(getUiSettings, (
  uiSettings,
) => uiSettings.onboardingType);
export const getOnboardingStep = createSelector(getUiSettings, (
  uiSettings,
) => uiSettings.onboardingStep);
export const getOnWaitingInteraction = createSelector(getUiSettings, (
  uiSettings,
) => uiSettings.waitingInteraction);
